                    ...
                    <form method="POST" action="{{ route('movies.update', $movie) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" 
                                        :value="old('title', $movie->title)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $movie->description) }}</textarea>
